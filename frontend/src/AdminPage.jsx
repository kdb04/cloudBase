            ...
            <main className="main-content">
                <div className="admin-container">
                    ...
                    <div className="admin-buttons">
                        <button className="admin-button" onClick={handleDynamicPricing}>Dynamic Pricing</button>
                        <button className="admin-button" onClick={handleMonitorRoutes}>Monitor Routes</button>
                    ...
                    <div className="schedule-form">
                        ...
                        <button className="admin-button" onClick={handleEditSchedule}>Edit Schedule</button>
                    </div>

                    {responseMessage && <p className="response-message">{responseMessage}</p>}
                    {alternativeFlights.length>0 && (
                        <div className="alternative-flights">
