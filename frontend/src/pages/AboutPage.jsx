      ...
      <div className="bg-gradient-to-br from-primary/10 via-purple-500/5 to-transparent">
        <div className="max-w-container mx-auto px-mobile md:px-tablet lg:px-desktop py-16 md:py-24">
          <div className="max-w-3xl mx-auto text-center">
            <h1 className="text-4xl md:text-5xl font-bold mb-6">About CloudBase Airways</h1>
          ...
          <Card hover padding="lg">
            <div className="flex items-start space-x-4 mb-4">
              <div className="p-3 bg-purple-100 dark:bg-purple-900/20 rounded-lg">
                <FaEye className="w-8 h-8 text-purple-600 dark:text-purple-400" />
              </div>
              <div>
        ...
        <Card className="mb-12" padding="lg">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="flex items-start space-x-3">
              <FaShieldAlt className="w-5 h-5 text-primary mt-1 flex-shrink-0" />
              <div>
            ...
            <div className="flex items-start space-x-3">
              <FaCheckCircle className="w-5 h-5 text-success mt-1 flex-shrink-0" />
              <div>
            ...
            <div className="flex items-start space-x-3">
              <FaUsers className="w-5 h-5 text-info mt-1 flex-shrink-0" />
              <div>
            ...
            <div className="flex items-start space-x-3">
              <FaStar className="w-5 h-5 text-warning mt-1 flex-shrink-0" />
              <div>
